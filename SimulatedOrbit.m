...
k=250;%Create "k" variable (number of steps are going to be computed)
...
for i=1:k%Creation of a for loop to read all the data stored in the variables
  fprintf(file,"(%d,%d)    (%d,%d)    %d    (%d,%d)\n",points(i,1),points(i,2),accelerations(i,1),accelerations(i,2),angles(i),longitudes(i,1),longitudes(i,2));%Print on the file all the different points and variables nice formatted
endfor%End the for loop
